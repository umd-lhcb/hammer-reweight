...
def parse_input():
    parser = ArgumentParser(
        description='filter particles and print its truth info.')
    ...
    parser.add_argument('-b', '--base-br', default='d_meson1_true_id',
                        help='specify the true ID branch.')

    parser.add_argument('-w', '--weight-br', default='wff',
                        help='specify the weight branch.')

    parser.add_argument('-o', '--ok-br', default='ham_ok',
                        help='specify the cut branch.')

    parser.add_argument('-B', '--add-br', nargs='+', default=[
        'd_meson1_true_m',
...
if __name__ == '__main__':
    ...
    print('Keep particles with these true IDs: {}'.format(
