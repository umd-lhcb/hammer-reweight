...
vector<vector<string>> BtoDstVars = {
  // // shifting 1-th param in + direction....
  // {
  //   "{avec: [4.178722587399205, -0.007069974393394782, -0.030016987255178953]}",
  //   "{bvec: [0.000521609502746615, 0.0001218001521750987, 0.0024516292402597673]}",
  //   "{cvec: [7.880004836034406e-06, 0.0034648419888289967]}",
  //   "{dvec: [0.002227513830133663, -0.008560671949987969]}",
  // },
  // // shifting 1-th param in - direction....
  // {
  //   "{avec: [-4.176057412579205, -0.0051280044066052185, -0.02011169274482105]}",
  //   "{bvec: [0.0005160541732533852, 0.00018732670782490134, -0.000780673240259767]}",
  //   "{cvec: [4.652165163965594e-06, 0.0030518864111710037]}",
  //   "{dvec: [0.002175455229866337, -0.0077311490500120315]}",
  // },
  // // shifting 2-th param in + direction....
  // {
  //   "{avec: [0.0013419449608439102, -0.0058152989872979136, -0.017329672382019563]}",
  //   "{bvec: [0.0005217069941582305, 0.0001382523053899305, 0.0004754893870954501]}",
  //   "{cvec: [-6.776043166161044e-06, 0.004233075192977343]}",
  //   "{dvec: [0.002208749931599126, -0.007837852899823099]}",
  // },
  // // shifting 2-th param in - direction....
  // {
  //   "{avec: [0.0013232298591560898, -0.006382679812702087, -0.032799007617980436]}",
  //   "{bvec: [0.0005159566818417697, 0.00017087455461006954, 0.00119546661290455]}",
  //   "{cvec: [1.9308213166161045e-05, 0.0022836532070226578]}",
  //   "{dvec: [0.0021942191284008744, -0.008453968100176902]}",
  // },
  // // shifting 3-th param in + direction....
  // {
  //   "{avec: [0.001331007769277282, -0.006408329144290525, -0.024758095009117166]}",
  //   "{bvec: [0.0005179631199129084, 3.388844226672522e-05, 0.005562085101951775]}",
  //   "{cvec: [5.23968638665323e-06, 0.002856300115324643]}",
  //   "{dvec: [0.002206106246196917, -0.00876113150823932]}",
  // },
  // // shifting 3-th param in - direction....
  // {
  //   "{avec: [0.001334167050722718, -0.0057896496557094754, -0.025370584990882836]}",
  //   "{bvec: [0.0005197005560870918, 0.0002752384177332748, -0.003891129101951775]}",
  //   "{cvec: [7.29248361334677e-06, 0.0036604282846753574]}",
  //   "{dvec: [0.0021968628138030835, -0.00753068949176068]}",
  // },
  // // shifting 4-th param in + direction....
  // {
  //   "{avec: [0.00133257135549247, -0.006078472254401627, -0.025014324343216498]}",
  //   "{bvec: [0.0005191111085674073, 0.00011959197445724173, 0.0006258101652873663]}",
  //   "{cvec: [-2.03166868930122e-06, 0.0032849724281392126]}",
  //   "{dvec: [0.0022233210618741346, -0.009752513653497158]}",
  // },
  // // shifting 4-th param in - direction....
  // {
  //   "{avec: [0.00133260346450753, -0.006119506545598373, -0.025114355656783504]}",
  //   "{bvec: [0.0005185525674325929, 0.0001895348855427583, 0.0010451458347126338]}",
  //   "{cvec: [1.456383868930122e-05, 0.003231755971860788]}",
  //   "{dvec: [0.0021796479981258656, -0.006539307346502843]}",
  // },
  // // shifting 5-th param in + direction....
  // {
  //   "{avec: [0.0013322239199725133, -0.0068363661457382366, -0.02516714397204137]}",
  //   "{bvec: [0.0005140200181935693, 0.00016830834094044137, 0.0008832060419790295]}",
  //   "{cvec: [-1.457561239857635e-05, 0.004307226586451038]}",
  //   "{dvec: [0.0021725215908572773, -0.008147971287791444]}",
  // },
  // // shifting 5-th param in - direction....
  // {
  //   "{avec: [0.0013329509000274866, -0.005361612654261764, -0.02496153602795863]}",
  //   "{bvec: [0.0005236436578064309, 0.00014081851905955867, 0.0007877499580209706]}",
  //   "{cvec: [2.710778239857635e-05, 0.002209501813548962]}",
  //   "{dvec: [0.002230447469142723, -0.008143849712208558]}",
  // },
  // // shifting 6-th param in + direction....
  // {
  //   "{avec: [0.0013325887736243985, -0.005998510506008454, -0.025075611742553874]}",
  //   "{bvec: [0.0005189692210939717, 0.00023704523740809356, 0.0008504215566553635]}",
  //   "{cvec: [3.6352442843590726e-06, 0.0033259962558584914]}",
  //   "{dvec: [0.00219835466714634, -0.008147632657270608]}",
  // },
  // // shifting 6-th param in - direction....
  // {
  //   "{avec: [0.0013325860463756015, -0.006199468293991546, -0.025053068257446128]}",
  //   "{bvec: [0.0005186944549060285, 7.208162259190649e-05, 0.0008205344433446367]}",
  //   "{cvec: [8.896925715640927e-06, 0.003190732144141509]}",
  //   "{dvec: [0.0022046143928536603, -0.008144188342729394]}",
  // },
  // // shifting 7-th param in + direction....
  // {
  //   "{avec: [0.0013325876009143156, -0.006037561872252276, -0.025072130037345954]}",
  //   "{bvec: [0.0005185288628680817, 4.142493235743327e-05, 0.0008411597425582609]}",
  //   "{cvec: [-1.6452878409793055e-05, 0.003301327325882022]}",
  //   "{dvec: [0.00219295464216978, -0.00814293442329947]}",
  // },
  // // shifting 7-th param in - direction....
  // {
  //   "{avec: [0.0013325872190856844, -0.006160416927747724, -0.025056549962654048]}",
  //   "{bvec: [0.0005191348131319185, 0.0002677019276425668, 0.0008297962574417392]}",
  //   "{cvec: [2.8985048409793055e-05, 0.0032154010741179784]}",
  //   "{dvec: [0.0022100144178302202, -0.008148886576700532]}",
  // },
  // // shifting 8-th param in + direction....
  // {
  //   "{avec: [0.0013325868538602947, -0.006097843261824593, -0.025064685170181514]}",
  //   "{bvec: [0.0005231326623972568, 0.00015304619355212048, 0.0008357408953240489]}",
  //   "{cvec: [4.9727281144733245e-06, 0.003260302930903588]}",
  //   "{dvec: [0.002243624532643115, -0.008145295599172427]}",
  // },
  // // shifting 8-th param in - direction....
  // {
  //   "{avec: [0.0013325879661397052, -0.0061001355381754075, -0.025063994829818487]}",
  //   "{bvec: [0.0005145310136027434, 0.00015608066644787956, 0.0008352151046759512]}",
  //   "{cvec: [7.559441885526675e-06, 0.0032564254690964126]}",
  //   "{dvec: [0.0021593445273568853, -0.008146525400827574]}",
  // },
  // // shifting 9-th param in + direction....
  // {
  //   "{avec: [0.001332587354092846, -0.006097518600587747, -0.025064536475809404]}",
  //   "{bvec: [0.0005159639771542735, 0.00015217583577062, 0.0008356460935120594]}",
  //   "{cvec: [2.469399858351286e-05, 0.003259773936368963]}",
  //   "{dvec: [0.0022021496296437035, -0.008145931086015787]}",
  // },
  // // shifting 9-th param in - direction....
  // {
  //   "{avec: [0.0013325874659071539, -0.0061004601994122535, -0.025064143524190598]}",
  //   "{bvec: [0.0005216996988457267, 0.00015695102422938004, 0.0008353099064879407]}",
  //   "{cvec: [-1.2161828583512862e-05, 0.0032569544636310375]}",
  //   "{dvec: [0.0022008194303562967, -0.008145889913984215]}",
  // },
  // // shifting 10-th param in + direction....
  // {
  //   "{avec: [0.0013325874170282074, -0.006099027116510913, -0.025064332377113308]}",
  //   "{bvec: [0.0005137807980489172, 0.00015465628576786798, 0.0008354724055043871]}",
  //   "{cvec: [5.481171944651197e-06, 0.0032583124707556447]}",
  //   "{dvec: [0.0022019826866229233, -0.008145902945483088]}",
  // },
  // // shifting 10-th param in - direction....
  // {
  //   "{avec: [0.0013325874029717925, -0.006098951683489087, -0.025064347622886694]}",
  //   "{bvec: [0.000523882877951083, 0.00015447057423213206, 0.000835483594495613]}",
  //   "{cvec: [7.050998055348802e-06, 0.0032584159292443557]}",
  //   "{dvec: [0.002200986373377077, -0.008145918054516914]}",
  // }
  // shifting 1-th param in + direction....
  // Alex: manually changed these 4 entries to be 10sigma rather than 1sigma
  {
    "{avec: [0.0011003090979695154, 0.0019016419277459356, 0.06643973933908755]}",
    "{bvec: [0.0005281947665358405, 0.00026927967168444806, -0.013840413943059935]}",
    "{cvec: [-0.00010816858660552353, 0.010318149162044333]}",
    "{dvec: [0.00211710173379089, -0.002926642117552185]}",
  },
  // shifting 1-th param in - direction....
  {
...
int main(int argc, char** argv) {
  ...
  for (int idx = 0; idx != trees.size(); idx++) {
    ...
    df            = df.Define("wff_nonsense", "get<1>(ff_result)");
    for (int i = 0; i < numOfFFVar; i++) {
      auto outputBrName = "wff_nonsense_var" + to_string(i + 1);
      df = df.Define(outputBrName, "get<" + to_string(i + 2) + ">(ff_result)");
      outputBrs.emplace_back(outputBrName);
    }
    outputBrs.emplace_back("wff_nonsense");
